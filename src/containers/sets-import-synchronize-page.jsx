...
class SetsImportSynchronizePage extends React.Component {
        ...
        return (
            <div>
                ...
                <Col lg={gvs.LG_CONDENSED} lgOffset={gvs.LG_OFFSET_CONDENSED}
                    ...
                    <h1 className="page-heading">Set Import</h1>
                    <div className="breadcrumb" style={{fontSize: 12, marginBottom: 15}}>
                        <strong>Synchronize Account</strong><span className="signup-step">&nbsp;&#8594;&nbsp;Set Import</span>
                    </div>
...
SetsImportSynchronizePage.contextTypes = {
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        dismissChangelogReport: () => {
            ...
            dispatch(replace(urls.SETS_IMPORT_URI))
        },
        downloadChangelogFn: () => {
            toastr.clean()
            utils.trackEventSynchronizedAccount("from set import sync page")
...
export default connect(mapStateToProps, mapDispatchToProps)(SetsImportSynchronizePage)
