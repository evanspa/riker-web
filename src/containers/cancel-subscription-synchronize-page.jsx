...
class CancelSubscriptionSynchronizePage extends React.Component {
    ...
    render() {
        ...
        const lapsed = userPaidEnrollmentEstablishedAt != null && finalFailedPaymentAttemptOccurredAt != null
        return (
            <div>
                ...
                <ChangelogResultsModal
                    ...
                    dismissChangelogReportButtonLabel={!enrolled ? "Close" : "Continue to cancel subscription"}/>
                <Modal
                    ...
                    <Modal.Body>
                        <p>You currently do not have an active Riker subscription.  It looks like you already cancelled your subscription from another device or browser window.</p>
                    </Modal.Body>
                    <Modal.Footer>
                ...
                <Modal
                    show={lapsed && _.isEmpty(changelogCounts)}
                    dialogClassName="riker-modal-dialog">
                    <Modal.Header>
                        <Modal.Title id="contained-modal-title-sm">
                            <div style={{display: "flex", alignItems: "center"}}>
                    ...
                    <Modal.Body>
                        <p>You currently do not have an active Riker subscription.  It looks like your account lapsed due to too many failed payment attempts.</p>
                    </Modal.Body>
                    <Modal.Footer>
                        <Tappable className="btn btn-default" onTap={() => navigateTo(urls.ACCOUNT_URI)}>Go to My Account</Tappable>
                    </Modal.Footer>
                ...
                <Col lg={gvs.LG_CONDENSED} lgOffset={gvs.LG_OFFSET_CONDENSED}
                    ...
                    <div className="breadcrumb" style={{fontSize: 12, marginBottom: 15}}>
                        <strong>Synchronize Account</strong><span className="signup-step">&nbsp;&#8594;&nbsp;Cancel Subscription&nbsp;&#8594;&nbsp;Finished</span>
                    </div>
...
CancelSubscriptionSynchronizePage.contextTypes = {
...
const mapStateToProps = state => {
    return {
        ...
        finalFailedPaymentAttemptOccurredAt: state.serverSnapshot["user/final-failed-payment-attempt-occurred-at"],
        changelogCounts: state.changelogCounts,
        becameUnauthenticated: state.becameUnauthenticated,
        accountStatuses: utils.accountStatuses(state),
        redisplayBannerAfter: state.redisplayBannerAfter.valuent
    }
}
    ...
    return {
        ...
        dismissChangelogReport: (transitionToCompletePage) => {
            ...
            if (transitionToCompletePage) {
                dispatch(replace(urls.CANCEL_SUBSCRIPTION_EXIT_INTERVIEW_URI))
            }
        },
        downloadChangelogFn: () => {
            toastr.clean()
            utils.trackEventSynchronizedAccount("from subscription cancellation synchronize  page")
...
export default connect(mapStateToProps, mapDispatchToProps)(CancelSubscriptionSynchronizePage)
