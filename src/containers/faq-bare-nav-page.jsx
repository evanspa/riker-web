...
class FaqBareNavPage extends React.Component {
    render() {
        const { navigateTo } = this.props
        return (
            <div>
                <RikerHelmet title="Riker FAQ" />
                <RikerNavBarBare nonClickable={true} />
                <Col lg={gvs.LG} lgOffset={gvs.LG_OFFSET}
                     md={gvs.MD} mdOffset={gvs.MD_OFFSET}
                     sm={gvs.SM} smOffset={gvs.SM_OFFSET}
                     xs={gvs.XS} xsOffset={gvs.XS_OFFSET}>
                    <FaqContent containerUrl={urls.FAQ_BARE_NAV_URI} />
                </Col>
            </div>
        )
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(FaqBareNavPage)
